...
A simple machine learning project to predict loan approval status based on applicant data using Logistic Regression.

##  Features
- Predicts loan approval (Yes/No)
- Uses historical loan data from Excel
